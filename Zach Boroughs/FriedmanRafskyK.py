...
class FriedmanRafskyK:
    ...
    def Prim(self, weight_mat, labels):
    ...
    def MST(self, data, labels, algorithm):
        ...
        if algorithm == 'Prim':
            ...
            MST_connections = self.Prim(G, labels)
    ...
    def permutation(self, nperm, labels, MST_connections):
        ...
        for itr in np.arange(nperm):
            ...
            run_val = self.num_runs(labels, MST_connections)
    ...
    def _statistic(self, x, y):
        ...
        MST_connections = self.MST(data, labels, algorithm = 'Kruskal')
        
        runs_true = self.num_runs(labels, MST_connections)
        
        runs = self.permutation(100, labels, MST_connections)
